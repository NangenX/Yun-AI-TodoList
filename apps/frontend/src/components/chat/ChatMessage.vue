<template>
  ...
  >
    <div
      class="rounded-xl leading-6 ltr relative transition-colors duration-200 tracking-[0.2px] word-break-break-word"
      :class="{
        'bg-button-bg text-white spacing-responsive-sm shadow-[0_2px_8px_rgba(212,193,138,0.3)] hover:shadow-[0_4px_12px_rgba(212,193,138,0.4)] leading-[1.3] font-medium text-responsive-sm':
          message.role === 'user',
